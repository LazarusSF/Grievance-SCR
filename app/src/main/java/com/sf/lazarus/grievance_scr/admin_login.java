...
public class admin_login extends AppCompatActivity {
    ...
    private EditText loginInputUname, loginInputPassword;
    ...
    loginInputUname = (EditText) findViewById(R.id.adminlogin_username);
    loginInputPassword = (EditText) findViewById(R.id.adminlogin_password);
    // Progress dialog
    ...
    public void forgotPressed(View v){
        startActivity(new Intent(admin_login.this,admin_forgot_pwd.class));

    }
    public void loginPressed(View v){
        loginAdmin(loginInputUname.getText().toString(),
    ...
    private void loginAdmin( final String username, final String password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                getString(R.string.adminlogin), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        String admin = jObj.getJSONObject("user").getString("username");
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlogin = (Button) findViewById(R.id.login_userlogin);
        btnLinkSignup = (Button) findViewById(R.id.register_userlogin);
        Button btnfrgtpwd=(Button) findViewById(R.id.userlogin_forgot_button);
        // Progress dialog
        progressDialog = new SpotsDialog(this,R.style.userlogin_custom);
        progressDialog.setCancelable(false);
