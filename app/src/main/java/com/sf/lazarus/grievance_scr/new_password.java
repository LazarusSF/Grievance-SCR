...
public class new_password extends AppCompatActivity {
    ...
    private EditText rp_pfno,rp_newpwd,rp_new_repwd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rp_pfno=(EditText) findViewById(R.id.new_pwd_enter_pfno);
        rp_newpwd=(EditText) findViewById(R.id.new_pwd_enter_pwd);
        rp_new_repwd=(EditText) findViewById(R.id.new_pwd_re_enter_pwd);

        submit=(FancyButton) findViewById(R.id.user_newpwd_submit_button);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                changePassword(rp_pfno.getText().toString(),
    ...
    private void changePassword(final String pf, final String pwd, final String re_pwd) {

        String cancel_req_tag = "reset";
        showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                getString(R.string.newpassword), new Response.Listener<String>() {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder reset_pwd=new AlertDialog.Builder(new_password.this);
        reset_pwd.setIcon(R.drawable.ic_error_outline_black_24dp)
                ...
                .setNegativeButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent myIntent = new Intent(new_password.this, user_login.class);
